...
namespace Shinyoh_Details
{
    public partial class TokuisakiDetail : SearchBase
    {
        ...
        string TokuisakiCD = string.Empty;
        bool isEnable;
        ...
        private void TokuisakiDetail_Load(object sender, EventArgs e)
        {
            ...
            TokuisakiCD = Access_Tokuisaki_obj.TokuisakiCD;
            DataTable dt = bl.ShokutiFLG_Select(TokuisakiCD, string.Empty, string.Empty, "Tokuisaki");
