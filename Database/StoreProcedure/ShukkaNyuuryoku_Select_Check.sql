    ...
    begin
        if exists(select * from D_Shukka where UriageKanryouKBN=1)
            ...
            select DS.ShukkaDate, DS.TokuisakiCD,DS.TokuisakiRyakuName,DS.TokuisakiName,DS.TokuisakiYuubinNO1,DS.TokuisakiYuubinNO2,
                    ...
                    convert(varchar(10), DSM.DenpyouDate, 111) as DenpyouDate
                    ,(DSM1.JuchuuNO +'-'+ cast(DSM1.JuchuuGyouNO as varchar)) as JuchuuNOGyouNO
                    ,DSM1.SoukoCD,F.ShouhinCD,DSM.UriageKanryouKBN                            
                    ,DSM.ShukkaGyouNO
