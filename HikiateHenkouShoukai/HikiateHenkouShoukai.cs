    ...
    public partial class HikiateHenkouShoukai : BaseForm
    {
        ...
        private void Radio_Changed(int type)
        {
            ...
            switch (type)
            {
                ...
                case 1:
                    ...
                    gvMainDetail.Size = new Size(1640, 565);
                ...
                case 2:
                    ...
                    gvFreeInventoryDetails.Size = new Size(1100, 565);
        ...
        private void Confirm_Data()
        {
            ...
            if (F8_dt1.Rows.Count > 0)
            {
                ...
                var dtConfirm = F8_dt1.AsEnumerable().OrderBy(r => r.Field<string>("ShouhinCD")).ThenBy(r => r.Field<string>("表示順")).ThenBy(r => r.Field<string>("受注番号")).ThenBy(r => r.Field<string>("受注番号-行番号")).CopyToDataTable();
